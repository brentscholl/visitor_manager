        ...
        @if(isset($styles['isNotice']))
            <div x-data="{ open: true }" @keydown.window.escape="open = false" x-show="open"
                ...
                <div x-show="open"
                    ...
                    class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity backdrop-blur-2"
                ></div>
                ...
                <div class="fixed z-10 inset-0 overflow-y-auto">
                    <div class="flex items-start justify-center min-h-full p-4 text-center sm:p-0">
                        ...
                        <div x-show="open"
                            ...
                            class="relative bg-red-50 border border-red-500 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all
