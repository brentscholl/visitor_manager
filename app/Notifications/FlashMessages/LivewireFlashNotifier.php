...
class LivewireFlashNotifier
{
    ...
    /**
     * Pop the last message off the stack and dispatch it to the Livewire component
     *
     * @param  Livewire\Component $livewire
     * @return \App\Notifications\FlashMessages\LivewireFlashNotifier
     */
