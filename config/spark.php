        ...
        'billables' => [
            ...
            'team' => [
                ...
                'plans' => [
                    [
                        'name'              => 'Standard',
                        'short_description' => 'An affordable monthly plan with everything you need to keep track of your visitors.',
                        'monthly_id'        => 'price_1OLBDbIznhvIuSFRHy2Hf2TS',
                        //'yearly_id' => 'price_id',
                        'features'          => [
                            'Unlimited sign ins',
                            'Unlimited locations',
                            'Unlimited guest list exporting',
                        ],
                    ],
                ],
